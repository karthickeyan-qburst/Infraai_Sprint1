...
function InventoryReportTable() {
  return (
    <div class="inventoryreporttable__container">
      <TableContainer component={Paper} sx={{overflow:'hidden', borderRadius:'10px', border:'0.001px solid rgba(224, 224, 224, 1)'}}>
        <Table>
        <TableHead className="reporttable__header" sx={{ '&:first-child td, &:first-child th': { border:0 }}}>
          ...
          <TableBody >
            ...
            <TableRow className="ireporttable__data" key="{row.name}">
              ...
              <TableCell align="left" className="data1" ># Lanes main</TableCell>
