...
export default function Login() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log('signIn credentials', user);
    } catch (err) {
      console.log('error');
    }
  };
    ...
    <>
      ...
      <Grid
        ...
        <Paper variant="outlined" className="iai_container">
          <Typography variant="h5" className="iai_title">
            Login
          </Typography>
          ...
          <Grid item className="iai_margin">
            ...
            <Typography className="iai_span;" component="span">
              Forgot Password?
            </Typography>
          </Grid>

          <Grid item className="iai_margin">
            <Button variant="contained" onClick={handleSubmit} className="iai_button" fullWidth>
              Login
            </Button>
          </Grid>
        </Paper>
